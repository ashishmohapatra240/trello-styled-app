...
const CreateTaskButton: React.FC<CreateTaskButtonProps> = ({ onClick }) => {
  return (
    <button onClick={onClick} className="flex gap-2 justify-center p-2 mt-4 text-xl font-medium text-white rounded-lg shadow-[0px_1px_8px_rgba(0,0,0,0.25)] max-md:px-5">
