...
const FeatureCard: React.FC<FeatureCardProps> = ({ imageSrc, title, description, className }) => {
  return (
    <article className={`flex flex-col w-[33%] max-md:ml-0 max-md:w-full ${className}`}>
